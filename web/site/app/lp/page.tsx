      ...
      <section className="px-4 py-20 bg-yellow-50">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg max-w-2xl mx-auto mb-8">
            ...
            <button 
              className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-bold py-4 px-12 rounded-full text-xl transition-all transform hover:scale-105"
              onClick={() => window.open('/', '_self')}
            >
              🔗 デモを試す
            </button>
