      ...
      <section className="px-4 py-20 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center">
            <a
              href="/"
              className="bg-purple-600 hover:bg-purple-700 text-white font-bold py-4 px-8 rounded-full text-lg transition-colors inline-block"
            >
              デモを見る
            </a>
      ...
      <section className="px-4 py-20 bg-gradient-to-r from-purple-100 to-pink-100">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-700 mb-8">
            ネルちゃんの1日を通して、CatSenseがどのように働くかご覧ください
          </p>
          <div className="bg-white p-8 rounded-2xl shadow-lg mb-8">
            <div className="text-4xl mb-4">📱</div>
            <h3 className="text-xl font-bold mb-4">インタラクティブタイムライン</h3>
            <p className="text-gray-700 mb-6">
              リアルタイムで更新される猫の行動パターンと気分の変化を確認できます
            </p>
            <a
              href="/"
              className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-bold py-3 px-8 rounded-full text-lg transition-all transform hover:scale-105 inline-block"
            >
              デモを開始
            </a>
          </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg max-w-2xl mx-auto mb-8">
            ...
            <div className="flex flex-col gap-4">
              <a
                href="/"
                className="bg-purple-600 hover:bg-purple-700 text-white font-bold py-3 px-8 rounded-full text-lg transition-all inline-block"
              >
                まずはデモを見る
              </a>
      ...
      <footer className="px-4 py-12 bg-gray-800 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex justify-center gap-6 mb-6">
            ...
            <a href="/lp" className="text-gray-400 hover:text-white transition-colors">
              ランディングページ
            </a>
          </div>
