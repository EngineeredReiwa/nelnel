  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-purple-100">
      ...
      <nav className="p-4">
        <Link 
          href="/" 
          className="inline-block bg-white/80 hover:bg-white text-gray-800 px-4 py-2 rounded-full transition-all duration-300 shadow-md hover:shadow-lg"
        >
          ← デモに戻る
        </Link>
      </nav>
      ...
      <section className="px-4 py-20 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center">
            <Link 
              href="/"
              className="bg-purple-600 hover:bg-purple-700 text-white font-bold py-4 px-8 rounded-full text-lg transition-colors"
            >
              デモを体験する
            </Link>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg max-w-2xl mx-auto mb-8">
            ...
            <div className="space-y-4">
              <Link 
                href="/"
                className="block bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-bold py-4 px-12 rounded-full text-xl transition-all transform hover:scale-105"
              >
                🎮 まずはデモを体験
              </Link>
